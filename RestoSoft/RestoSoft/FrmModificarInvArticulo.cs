...
namespace RestoSoft
{
    public partial class FrmModificarInvArticulo : Form
    {
        public FrmModificarInvArticulo()
        {
            InitializeComponent();
        }
        ...
        private void inventariosBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            ...
            ingredientesTextBox.Enabled = false;
            existenciaTextBox.Enabled = false;
            proveedorTextBox.Enabled = false;
        }

        private void FrmModificarInvArticulo_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ingredientesTextBox.Enabled = true;
