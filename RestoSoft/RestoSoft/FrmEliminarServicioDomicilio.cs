...
namespace RestoSoft
{
    public partial class FrmEliminarServicioDomicilio : Form
    {
        public FrmEliminarServicioDomicilio()
        {
            InitializeComponent();
        }
        ...
        private void FrmEliminarServicioDomicilio_Load(object sender, EventArgs e)
        {
